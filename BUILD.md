To build and publish your `durable_dot_dict` package to PyPI, follow these steps:
...
```
durable_dot_dict/
│── durable_dot_dict/     # Package directory
...
- The `__init__.py` file inside `durable_dot_dict/` ensures it's treated as a package.
...
```sh
pip install dist/durable_dot_dict-0.0.1-py3-none-any.whl
```
